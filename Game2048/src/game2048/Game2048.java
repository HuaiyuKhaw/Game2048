      ...
      @Override
        ...
        static class Tile {
            ...
            public Color getBackground() {
                switch (value) {
                    case 'A': return new Color(0xeee4da);
                    case 'B': return new Color(0xede0c8);
                    case 'C': return new Color(0xf2b179);
                    case 'D': return new Color(0xf59563);
                    case 'E': return new Color(0xf67c5f);
                    case 'F': return new Color(0xf65e3b);
                    case 'G': return new Color(0xedcf72);
                    case 'H': return new Color(0xedcc61);
                    case 'I': return new Color(0xedc850);
                    case 'J': return new Color(0xedc53f);
                    case 'K': return new Color(0xeee4da);
                    case 'L': return new Color(0xede0c8);
                    case 'M': return new Color(0xf2b179);
                    case 'N': return new Color(0xf59563);
                    case 'O': return new Color(0xf67c5f);
                    case 'P': return new Color(0xf65e3b);
                    case 'Q': return new Color(0xedcf72);
                    case 'R': return new Color(0xedcc61);
                    case 'S': return new Color(0xedc850);
                    case 'T': return new Color(0xedc53f);
                    case 'W': return new Color(0x00ffbf);
                    case 'X': return new Color(0x0040ff);
                    case 'Y': return new Color(0xcc2efa);
                    case 'Z': return new Color(0x5858fa);
                }
